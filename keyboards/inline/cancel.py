...
def custom_cancel_button(callback_data: str, text: str = '❌ Отмена') -> InlineKeyboardButton:
    return InlineKeyboardButton(text=text, callback_data=f'{callback_data}')


def custom_cancel_keyboard(callback_data: str, text: str = '❌ Отмена') -> InlineKeyboardMarkup:
