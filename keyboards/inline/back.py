...
def custom_back_button(callback_data: str, text: str = '◀ Назад') -> InlineKeyboardButton:
    return InlineKeyboardButton(text=text, callback_data=f'{callback_data}')


def custom_back_keyboard(callback_data: str, text: str = '◀ Назад') -> InlineKeyboardMarkup:
