...
class Paginator:
    def __init__(
            ...
            page_separator: str = '/',
            dp: Dispatcher = None,
            back_button: types.InlineKeyboardButton = None
    ):
        """
        ...
        :param back_button: Button to get previous dialog page. Default = None
        """
        self.dp = dp
    ...
    def paginator_handler(self) -> tuple[
        ...
        async def _page(call: types.CallbackQuery, state: FSMContext):
            ...
            # TODO add callbackquery answer to call id
